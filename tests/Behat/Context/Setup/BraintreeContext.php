...
final class BraintreeContext implements Context
{
    ...
    /**
     * @Given the store has a payment method :paymentMethodName with a code :paymentMethodCode and Braintree payment gateway
     */
    public function theStoreHasAPaymentMethodWithACodeAndBraintreePaymentGateway(string $paymentMethodName, string $paymentMethodCode): void
    {
        $paymentMethod = $this->createPaymentMethodBraintree(
            $paymentMethodName,
            $paymentMethodCode,
            BraintreeGatewayFactory::FACTORY_NAME,
            'Braintree'
        );
    ...
    private function createPaymentMethodBraintree(
        string $name,
        string $code,
        string $factoryName,
        string $description = '',
